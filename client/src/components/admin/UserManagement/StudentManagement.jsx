        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center w-full lg:w-auto space-y-4 sm:space-y-0 sm:space-x-4">
            <div className="flex-1">
              <h1 className="text-xl lg:text-2xl font-bold text-[#890c25]">Student Management</h1>
                    ...
                    currentRecords.map((student, index) => (
                      ...
                      >
                        {columns.map(column => {
                          ...
                          // Common cell styling
                          const baseCellClasses = "px-2 lg:px-4 py-3 lg:py-3 text-xs lg:text-sm border-b border-gray-200";
